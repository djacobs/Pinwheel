...
GovernanceEventType = Literal[
    ...
    "proposal.passed",
    "proposal.failed",
    "proposal.enactment_held",
    "proposal.enactment_approved",
    "proposal.enactment_rejected",
    "rule.enacted",
    "rule.rolled_back",
    "token.regenerated",
    "token.spent",
    ...
    "proposal.codegen_requested",
    "proposal.codegen_ready",
    "proposal.codegen_rejected",
    "proposal.codegen_failed",
]
