...
- [x] Demo verification — Showboat/Rodney pipeline (Session 89 — video demo storyboard + 10 screenshots)
...
- [x] **(19)** Reconcile product/docs claims with shipped behavior (report types, season flow, acceptance criteria) across `docs/product/*.md` and `docs/ACCEPTANCE_CRITERIA.md`. (Session 89 — 8 files, 67 gaps fixed)
...
- [x] **(3)(4)(5)(6)** Close remaining doc/dev-log alignment gaps. (Completed in Session 89 as part of item 19)
